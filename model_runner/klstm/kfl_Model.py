...
class Model(object):
    def __init__(self,params,is_training = True):
        ...
        hidden_vector_size=params['n_hidden']
        ...
        for i in range(num_layers):
            cell = rnncell.ModifiedLSTMCell(hidden_vector_size, W_size, forget_bias=1, initializer=tf.contrib.layers.xavier_initializer(),
